...
$sql = " SELECT * FROM employee WHERE D_ID='D05' ORDER BY E_ID DESC ";
...
<body>
    ...
    <div class="container">
		...
		<a href="\login\zoo\managerup.html"><button class="btn btn1">MANAGER UPDATE</button></a>
    </div>
    <!DOCTYPE html>

    <?php
	
	$sql = " SELECT * FROM todo WHERE D_ID='D05' ORDER BY TASK_NO DESC ";
	$result = $mysqli->query($sql);
	$mysqli->close();
?>
<html lang="en">
	...
	<a href="\login\first.html"><button class="btn btn1">logout</button></a>
        ...
        <div class="container01">
                <a href="\todo\add.html"><button class=" btn btn1">ADD</button></a>
                <a href="todo\todo.html"><button class="btn btn1">DELETE/UPDATE</button></a>
            </div>
	</body>
</html>